...
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('davidesari@yahoo.com', SHA2('12345678', 256), 'Davide', 'Sari', 'Palermo, Via LibertÃ  15', '3517628334', '8901034567391234', 'Davide Sari', 165); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
...
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('simonebianchi@yahoo.com', SHA2('45678912', 256), 'Simone', 'Bianchi', 'Milano, Via VeritÃ  83', '3479990110', '7823019820351234', 'Simone Bianchi', 999); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
...
INSERT INTO Prodotto (nome, descrizione, prezzo, speseSpedizione, emailVenditore, tag, nomeTipologia, dataAnnuncio, model)
VALUES ('GameBoy', 'GameBoy con case stampato in 3d, a cui Ã¨ stato aggiunto un raspberry per emulazione', 39.99, 3.00, 'dantealig@gmail.com', 'Videogiochi', 'Gadget', current_date(), 'gameboy.jpg');
INSERT INTO Prodotto (nome, descrizione, prezzo, speseSpedizione, emailVenditore, tag, nomeTipologia, dataAnnuncio, model)
...
INSERT INTO Prodotto (nome, descrizione, prezzo, speseSpedizione, emailVenditore, tag, nomeTipologia, dataAnnuncio, model)
VALUES ('Cavaliere di Dark Souls', 'Alto 25 cm e giÃ  colorato', 31.99, 0.00, 'michver@yahoo.com', 'Videogiochi', 'Action Figures', current_date(), 'darksouls.jpg');
INSERT INTO Prodotto (nome, descrizione, prezzo, speseSpedizione, emailVenditore, tag, nomeTipologia, dataAnnuncio, model)
